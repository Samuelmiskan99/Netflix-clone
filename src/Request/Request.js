...
const Request = {
   ...
   requestPopular: `https://api.themoviedb.org/3/discover/movie?api_key=${api_key}&include_adult=false&include_video=false&language=en-US&page=3&sort_by=popularity.desc`,
   ...
   requestTrendingTvShow: `https://api.themoviedb.org/3/trending/tv/week?api_key=${api_key}`, // Add this line
};
